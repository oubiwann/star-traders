...
00020 REM - MODIFIED FOR THE MICROBEE BY JOHN ZAITSEFF, 1988
00030 REM
00035 DEFINT C
00036 DEFINT I
...
00270   NEXT I
00280 PRINT Z1$
00290 INPUT "HOW MANY PLAYERS  (1-4)  ";P1
00300 PRINT:PRINT
00310 PRINT "DOES ANY PLAYER NEED INSTRUCTIONS  "
00315 INPUT "(TYPE 0 FOR NO)";Q
00320 IF Q<>0 THEN GOSUB 3410
00330 PRINT Z1$
00340   FOR I=1 TO P1
...
01240 GOTO 1760
01250 IF A1>3 AND A2>3 AND A2<>A1 THEN GOSUB 2220:REM - LINE 2220 IS
...
02040   NEXT I
02050 GOTO 590
02060 PRINT Z1$: REM             SUBROUTINE - PRINT MAP
...
03150 PRINT C$;" HAS SPLIT 2 FOR 1 !"
...
03730 PRINT "SPACE THAT IS ADJACENT TO ONE - AND ONLY ONE EXISTING"
03740 PRINT "SHIPPING LANE, THE SPACE HE SELECTS WILL BE ADDED TO"
03750 PRINT "THAT SHIPPING LANE AND WILL BE DESIGNATED WITH THE FIRST"
...
03920 PRINT "ISSUED 5 SHARES IN THE NEW COMPANY AS A REWARD.  HE"
...
04100 PRINT "THE DEFUNCT COMPANY IS EXCHANGED FOR SHARES IN THE"
...
04180 GOSUB 3620
04190 PRINT Z1$
04200 PRINT "   NEXT THE COMPUTER ADDS STOCK DIVIDENDS TO THE PLAYER'S"
04210 PRINT "CASH ON HAND (5% OF THE MARKET VALUE OF THE STOCK IN HIS"
04220 PRINT "POSSESSION), AND OFFERS HIM THE OPPORTUNITY TO PURCHASE"
...
04260 PRINT "GAME TO DETERMINE THE WINNER.  IF THE MARKET VALUE OF A GIVEN"
...
04290 PRINT "THE NUMBER OF SHARES OWNED BY EACH PLAYER IS DOUBLED."
04300 PRINT
